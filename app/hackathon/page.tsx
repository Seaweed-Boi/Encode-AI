...
import { Calendar, Clock, MapPin, Users, Trophy, Zap, Brain, Code } from "lucide-react"
        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
              <div className="mb-16 text-center">
                ...
                <p className="mx-auto max-w-2xl text-lg font-mono text-white">
                  Powered by industry leaders supporting AI innovation
                </p>
              </div>
              <div className="grid gap-8 md:grid-cols-3">
                <div className="flex items-center justify-center rounded-none border-2 border-white bg-black p-12 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  <div className="text-center">
                    <div className="mb-4 text-4xl font-bold uppercase text-[rgb(255,102,0)]">Sponsor 1</div>
                    <p className="font-mono text-xs text-white">Title Sponsor</p>
                  </div>
                </div>
                <div className="flex items-center justify-center rounded-none border-2 border-white bg-black p-12 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  <div className="text-center">
                    <div className="mb-4 text-4xl font-bold uppercase text-[rgb(255,102,0)]">Sponsor 2</div>
                    <p className="font-mono text-xs text-white">Gold Sponsor</p>
                  </div>
                </div>
                <div className="flex items-center justify-center rounded-none border-2 border-white bg-black p-12 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  <div className="text-center">
                    <div className="mb-4 text-4xl font-bold uppercase text-[rgb(255,102,0)]">Sponsor 3</div>
                    <p className="font-mono text-xs text-white">Silver Sponsor</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="border-t-4 border-white bg-zinc-950">
            <div className="mx-auto max-w-4xl px-6 py-24 lg:px-8">
              <div className="rounded-none border-2 border-white bg-black p-12 shadow-[12px_12px_0px_0px_rgba(255,255,255,1)]">
                ...
                <form className="space-y-6">
                  <div>
                    <label className="mb-2 block font-mono text-sm font-bold uppercase text-white">
                      Team Name
                    </label>
                    <input
                      type="text"
                      className="w-full rounded-none border-2 border-white bg-black px-4 py-3 font-mono text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] focus:outline-none focus:ring-2 focus:ring-[rgb(255,102,0)]"
                  ...
                  <div>
                    ...
                    <select className="w-full rounded-none border-2 border-white bg-black px-4 py-3 font-mono text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] focus:outline-none focus:ring-2 focus:ring-[rgb(255,102,0)]">
                  ...
                  <div>
                    <label className="mb-2 block font-mono text-sm font-bold uppercase text-white">
                      Upload Project Submission Draft (PDF Only , Max Size 10 MB)
                    </label>
                    <div className="relative">
                      <input
                        type="file"
                        accept=".pdf"
                        className="w-full rounded-none border-2 border-white bg-black px-4 py-3 font-mono text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] focus:outline-none focus:ring-2 focus:ring-[rgb(255,102,0)] file:mr-4 file:rounded-none file:border-0 file:bg-[rgb(255,102,0)] file:px-4 file:py-2 file:font-mono file:text-sm file:font-bold file:uppercase file:text-black hover:file:bg-[rgb(255,120,0)]"
                      />
                    </div>
                    <p className="mt-2 font-mono text-xs text-white">Max file size: 5MB</p>
                  </div>
          ...
          <section className="border-t-4 border-white">
            <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
              ...
              <div className="mt-12 text-center">
                ...
                <a href="mailto:hackathon@encodeai.com" className="font-mono text-lg font-bold text-[rgb(255,102,0)] hover:underline">
                  hackathon@encodeai.com
                </a>
              </div>
            </div>
          </section>
